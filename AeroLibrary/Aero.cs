...
namespace AeroLibrary
{
    public class Aero
    {
        ...
        public static void DisabledAcrylic(IWin32Window window)
        {
            try
            {
                if (window == null) throw new ArgumentNullException(nameof(window));
        ...
        //public static void EnableGradient(IWin32Window window, Color Colorfrom, Color Colorto)
        //{
        ...
        //        GradientColor = ToAbgr(Colorfrom)
        //    };
